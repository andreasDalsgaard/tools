...
public class Config {
	...
	public static final String COMMANDLINE_JVM_MODEL = "jvm_model";
	public static final String COMMANDLINE_APPLICATION = "application";
	...
	public static final String COMMANDLINE_RUNANALYZER = "run_analyzer";
}
